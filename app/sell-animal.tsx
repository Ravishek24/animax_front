      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.uploadContainer}>
          ...
          <View style={styles.videoSection}>
            <Text style={styles.infoText}>{t('videoSellFaster')}</Text>
            <View style={styles.videoIconContainer}>
              <Icon name="video" size={40} color="#9E9E9E" />
            </View>
            <TouchableOpacity style={styles.uploadButton}>
              <Text style={styles.uploadButtonText}>{t('selectVideo')}</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.photoSection}>
            <View style={styles.photoRow}>
              <View style={styles.photoBox}>
                <Text style={styles.photoTitle}>{t('selectPhotoUdder')}</Text>
                <Image 
              ...
              <View style={styles.photoBox}>
                <Text style={styles.photoTitle}>{t('selectPhotoSide')}</Text>
                <Image 
          ...
          <View style={styles.locationSection}>
            <View style={styles.sectionTitle}>
              ...
              <Text style={styles.sectionTitleText}>{t('place')}</Text>
            </View>
            <Text style={styles.locationInfo}>
              {t('locationShownToBuyers')}
            </Text>
          ...
          >
            <Text style={styles.registerButtonText}>{t('registerUpload')}</Text>
          </TouchableOpacity>
    ...
    return (
      <ScrollView style={styles.scrollView}>
        <View style={styles.formHeader}>
          <Text style={styles.formTitle}>{t('sellAnimalTitle')}</Text>
          <TouchableOpacity style={styles.myAnimalsButton}>
            <Text style={styles.myAnimalsText}>{t('myAnimals')}</Text>
        ...
        <View style={styles.formSection}>
          <View style={styles.formLabelRow}>
            ...
            <Text style={styles.formLabel}>{t('whichAnimal')}</Text>
            <Text style={styles.requiredStar}>*</Text>
          </View>
          <TouchableOpacity style={styles.dropdown}>
            <Text style={styles.dropdownText}>{t('selectAnimal')}</Text>
        ...
        <View style={styles.formSection}>
          <View style={styles.formLabelRow}>
            <Icon name="cow" size={24} color="#9E9E9E" />
            <Text style={styles.formLabel}>{t('breedLabel')}</Text>
            <Text style={styles.requiredStar}>*</Text>
          </View>
          <TouchableOpacity style={styles.dropdown}>
            <Text style={styles.dropdownText}>{t('selectBreed')}</Text>
        ...
        <View style={styles.formSection}>
          <View style={styles.formLabelRow}>
            <Icon name="cow" size={24} color="#9E9E9E" />
            <Text style={styles.formLabel}>{t('currentMilkPerDay')}</Text>
            <Text style={styles.requiredStar}>*</Text>
          </View>
          <Text style={styles.milkSubLabel}>{t('todayTwoTimesMilk')}</Text>
          <View style={styles.inputWithUnit}>
            ...
            <View style={styles.unitContainer}>
              <Text style={styles.unitText}>{t('litersUnit')}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.formSection}>
          <View style={styles.formLabelRow}>
            <Icon name="cow" size={24} color="#9E9E9E" />
            <Text style={styles.formLabel}>{t('milkCapacityPerDay')}</Text>
            <Text style={styles.requiredStar}>*</Text>
          </View>
          <Text style={styles.milkSubLabel}>{t('maxMilkEver')}</Text>
          <View style={styles.inputWithUnit}>
              <TextInput 
              style={styles.numberInput}
              value={maxMilk}
        ...
        <View style={styles.priceContainer}>
          ...
          <View style={styles.formSection}>
            <View style={styles.formLabelRow}>
              ...
              <Text style={styles.formLabel}>{t('priceRate')}</Text>
              <Text style={styles.requiredStar}>*</Text>
            </View>
            <Text style={styles.priceSubLabel}>{t('correctRateMoreCalls')}</Text>
            <View style={styles.inputWithUnit}>
              <TextInput 
                style={styles.numberInput}
                value={price}
              ...
              />
              <View style={styles.unitContainer}>
                <Text style={styles.unitText}>{t('rupees')}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.negotiableSection}>
            <View style={styles.negotiableContent}>
              ...
              <View style={styles.negotiableTextContainer}>
                <Text style={styles.negotiableTitle}>{t('negotiation')}</Text>
                <Text style={styles.negotiableSubtitle}>{t('negotiationSubtitle')}</Text>
                <Text style={styles.negotiableDesc}>{t('negotiationDesc')}</Text>
              </View>
              <Switch
                value={negotiable}
          ...
          <View style={styles.photoUploadSection}>
            <View style={styles.formLabelRow}>
              ...
              <Text style={styles.formLabel}>{t('addPhotoAtLeastOne')}</Text>
              <Text style={styles.requiredStar}>*</Text>
            </View>
            <Text style={styles.photoUploadInfo}>{t('goodPhotosSellFaster')}</Text>
          </View>
          ...
          <TouchableOpacity style={styles.permissionButton}>
            ...
            <Text style={styles.permissionButtonText}>{t('allowPhotoPermission')}</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    );
