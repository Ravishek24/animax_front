    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity style={styles.navItem} onPress={() => router.push('/')}>
          ...
          <Text style={styles.navText}>Anymax</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.navItem} onPress={() => router.push('/buy-animal')}>
          <Icon name="cart-outline" size={24} color="#757575" />
          <Text style={styles.navText}>पशु खरीदें</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.navItem}>
          <Icon name="tag-outline" size={24} color="#D32F2F" />
          <Text style={[styles.navText, styles.activeNavText]}>पशु बेचें</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={styles.navItem} onPress={() => router.push('/vip')}>
          <Icon name="crown" size={24} color="#757575" />
